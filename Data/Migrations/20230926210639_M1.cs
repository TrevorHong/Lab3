    ...
    public partial class M1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Province",
                columns: new[] { "ProvinceCode", "Population", "ProvinceName" },
                values: new object[,]
                {
                    { "AB", 4067175, "Alberta" },
                    { "BC", 4648055, "British Columbia" },
                    { "SK", 1098352, "Saskatchewan" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "Red Deer", 103588, "AB" },
                    { 7, "Saskatoon", 246376, "SK" },
                    { 8, "Regina", 215106, "SK" },
                    { 9, "Prince Albert", 35802, "SK" }
                });
